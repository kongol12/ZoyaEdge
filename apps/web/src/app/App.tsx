...
import { AuthProvider, useAuth, auth } from '@shared/lib/auth';
import { LanguageProvider } from '@shared/lib/i18n';
import { ThemeProvider } from '@shared/lib/theme';
import { ClientLayout } from '@shared/components/templates/client/ClientLayout';
import { AdminLayout } from '@shared/components/templates/admin/AdminLayout';
...
import AddTrade from '@/pages/client_old/AddTrade';
import ImportTrades from '@/pages/client_old/ImportTrades';
...
import Onboarding from '@/pages/client_old/Onboarding';
import StrategyBuilder from '@/pages/client_old/StrategyBuilder';
import Notebook from '@/pages/client_old/Notebook';
import AICoach from '@/pages/client_old/AICoach';
import Journal from '@/pages/trades/TradesPage';
import Academy from '@/pages/client_old/Academy';
import TradeView from '@/pages/trades/TradeDetailPage';
import Statistics from '@/pages/client_old/Statistics';
import Calendar from '@/pages/client_old/Calendar';
import News from '@/pages/client_old/News';
import Alerts from '@/pages/client_old/Alerts';
